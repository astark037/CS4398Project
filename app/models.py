...
class Employee(UserMixin, db.Model):
    ...
    home_address = db.Column(db.String(60), index=True)
    mailing_address = db.Column(db.String(60), index=True)
    home_phone = db.Column(db.String(15), index=True)
    cell_phone = db.Column(db.String(15), index=True)
...
class Payroll(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    account_type = db.Column(db.String(8), index=True)
    account_num = db.Column(db.String(9), index=True)
    routing_num = db.Column(db.String(9), index=True)
...
class Compensation(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    pay_period = db.Column(db.String(60), index=True)
